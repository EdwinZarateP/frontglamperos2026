                ...
                <div className="px-5 pb-5">
                  <div className="flex items-center gap-2 border border-stone-300 rounded-xl px-4 py-2.5 mb-4 focus-within:ring-2 focus-within:ring-brand">
                    ...
                    <input
                      ...
                      className="flex-1 text-base text-stone-700 placeholder:text-stone-400 focus:outline-none"
                      autoFocus
                    />
                    {locationInput && (
          ...
          {activePanel === 'location' && (
            <div className="absolute top-full left-0 mt-2 w-full sm:w-96 bg-white rounded-2xl shadow-2xl border border-stone-200 p-4 z-50">
              ...
              <input
                ...
                value={locationInput}
                onChange={(e) => setLocationInput(e.target.value)}
                className="w-full border border-stone-300 rounded-xl px-4 py-2.5 text-base text-stone-700 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-brand mb-3"
              />
              {ciudadesFiltradas.length > 0 ? (
                <ul className="space-y-1 max-h-52 overflow-y-auto">
                  {ciudadesFiltradas.map((c) => (
